...
export interface QueryAllResourceResponse {
  Resource?: { id?: string; title?: string; body?: string; creator?: string }[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<{ params?: object }, { code?: number; message?: string; details?: { "@type"?: string }[] }>({
      path: `/bryanchain/bryanchain/params`,
      method: "GET",
      ...params,
    });
  ...
  queryResourceAll = (
    ...
    >({
      path: `/bryanchain/bryanchain/resource`,
      method: "GET",
      query: query,
      ...params,
    });
   ...
   */
  queryResource = (id: string, params: RequestParams = {}) =>
    this.request<
      { Resource?: { id?: string; title?: string; body?: string; creator?: string } },
      { code?: number; message?: string; details?: { "@type"?: string }[] }
    >({
      path: `/bryanchain/bryanchain/resource/${id}`,
      method: "GET",
      ...params,
    });
}
